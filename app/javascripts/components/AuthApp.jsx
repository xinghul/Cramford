  ...
  renderLocalContent() {
    let localContent = do {
      if (this.state.step === 1) {
        <LoginApp toggleModal={this._toggleModal} setStep={this._setStep} />
      } else if (this.state.step === 2) {
        <SignupApp toggleModal={this._toggleModal} setStep={this._setStep} />
      } else if (this.state.step === 3) {
        <ForgotPasswordApp toggleModal={this._toggleModal} setStep={this._setStep} />
      }
    }
